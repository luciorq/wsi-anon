 ...
 * the anonymiaztion of more than one format). Add your format to the 'VENDOR_AND_FORMAT_STRINGS' variable in
...
int32_t handle_format(const char **filename, const char *new_filename, const char *pseudonym_metadata,
