...
int32_t handle_ventana(const char **filename, const char *new_label_name, bool disable_unlinking, bool do_inplace);
...
int32_t wipe_and_unlink_ventana_directory(file_t *fp, struct tiff_file *file, int32_t directory, bool big_endian, bool disable_unlinking);
