...
def anonymize_wsi(filename, new_label_name, delete_macro_image=True, disable_unlinking=False, disable_inplace=True):
    global _wsi_anonymizer
    ...
    result = _wsi_anonymizer.anonymize_wsi(filename, new_label_name, delete_macro_image, disable_unlinking, disable_inplace)
    return result